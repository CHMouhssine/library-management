...
void mainmenu()
{
	...
	case '4':
		...
		printf("Programmer....");
		gotoxy(16,4);
		printf("1. Mouhssine Chkarka");
		gotoxy(16,5);
		printf("   Mobile:0708174083  E-mail:ing.mouhssine.chkarka@gmail.com");
		gotoxy(16,7);
		printf("2. chat gpt 3 helps with understanding many conepts ");
		gotoxy(16,9);
		printf("With  the Unexplainable Help of Mme.Zaimi");
		gotoxy(10,15);
...
void deletebooks()    //function that delete items from file fp
{
	...
	if(findbook=='t' )
	{
		...
		fclose(fp);
		remove("moh.dat");
		rename("test.dat","moh.dat"); //copy all item from temporary file to fp except that
		fp=fopen("moh.dat","rb+");    //we want to delete
		if(findbook=='t')
		{
		    gotoxy(10,10);
...
void searchbooks()
{
    ...
    gotoxy( 15,20);
    printf("Enter Your Choice");
    fp=fopen("moh.dat","rb+"); //open file for reading propose
